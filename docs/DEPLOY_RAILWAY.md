...
4. **Variables** tab — add:
   ...
   | `SLEEPWATCH_PATH` | `/data/sleepwatch.json` — the sleep watcher's state file (auto white-noise when the Master Bedroom looks asleep, 22:00–08:00; toggle on the Automations screen) |
